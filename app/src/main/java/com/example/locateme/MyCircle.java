...
public class MyCircle extends AppCompatActivity {
    ...
    CollectionReference userCollection = FirebaseFirestore.getInstance().collection("users")
            .document(UserId).collection("mycircles");
    ...
    private void setUpRecyclerView() {
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {
            ...
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                if(direction==ItemTouchHelper.LEFT){
                    final androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(MyCircle.this);
                    builder.setMessage( "Delete user from circle?" )
                            ...
                            .setPositiveButton( "Yes", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    Toast.makeText(MyCircle.this, "User deleted.", Toast.LENGTH_LONG).show();
                                }
                            } )
                    ...
                    Toast.makeText(MyCircle.this, "You swiped right"+viewHolder.toString(), Toast.LENGTH_LONG).show();
                }
            }
        ...
        adapter.setOnClickListener(new MembersAdapter.onItemClickListener() {
            ...
            public void onItemClick(DocumentSnapshot documentSnapshot, int position) {
                ...
                String id = documentSnapshot.getString("mycircles");
                ...
                FirebaseFirestore.getInstance().collection("users").document(id).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        ...
                        Intent intent = new Intent(MyCircle.this, UserActivity.class);
